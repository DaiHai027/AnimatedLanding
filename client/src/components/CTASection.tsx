      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-1 rounded-3xl animate-border-light opacity-60"></div>
            <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-transparent via-purple-500/20 to-transparent animate-border-light blur-sm"></div>
            
            <div className="relative bg-slate-900/40 backdrop-blur-xl border border-slate-700/30 rounded-3xl p-16 shadow-2xl">
                <motion.h2 
